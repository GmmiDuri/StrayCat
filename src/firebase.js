...
export {
    signInWithPopup, signOut, createUserWithEmailAndPassword, signInWithEmailAndPassword, sendEmailVerification, updateProfile,
    setDoc, doc, getDoc, collection, query, where, getDocs
};
export default app;
